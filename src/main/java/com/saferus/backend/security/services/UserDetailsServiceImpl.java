...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserBydNif(String nif)
        throws UsernameNotFoundException {

            User user = userRepository.findOptionalUserByNif(nif)
                    .orElseThrow(()
                            -> new UsernameNotFoundException("Utiliador não encontrado -> Nif : " + nif)
                    );
